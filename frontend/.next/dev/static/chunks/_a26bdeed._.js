...
const AuthProvider = ({ children })=>{
    ...
    const signup = async (name, email_0, password_0)=>{
        try {
            const response_0 = await fetch('http://localhost:5000/api/auth/register', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            if (response_0.ok) {
                ...
                throw new Error(data_0.message || 'Signup failed');
            }
        } catch (error_0) {
            throw error_0;
        }
...
_s(AuthProvider, "nmeM8YnR0PlKzXEQvA+iBxv0BW0=", false, function() {
    return [
...
const useAuth = ()=>{
    ...
    if ($[0] !== "5c6024f0cf544bd82bcb7ef64e10c07618ccb2bff27bafd25fd190a9281a5a63") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5c6024f0cf544bd82bcb7ef64e10c07618ccb2bff27bafd25fd190a9281a5a63";
    }
...
//# sourceMappingURL=_a26bdeed._.js.map